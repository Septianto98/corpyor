...
const ChooseUs = () => {
  return (
    <div className="relative min-h-screen bg-[#1a1a1a] py-20 md:py-0 md:pt-75 md:pb-50 px-4 md:px-30 -mt-3 md:mt-0 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row h-full justify-between items-start w-full gap-10">
        <p className="font-inter leading-[150%]  w-full text-base md:w-100 text-whitebase font-normal order-2 md:order-1">
